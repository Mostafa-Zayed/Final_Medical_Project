...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h4><a href="<?=ADMIN_URL?>index.php">Dashboard</a> / <a href="<?=ADMIN_URL.'service_types/view.php'?>">Service Types </a> / <a href="<?=ADMIN_URL.'service_types/add.php'?>"> Add Service Type</a></h4>
            <br>
                ...
                <div class="panel-body">
                    ...
                    <?php if (isset($_POST['submit'])) {
                            ...
                            if (empty($errors)) {
                                ...
                                if ($restult) {
                                    $success = '<div class="alert alert-success">Service Type Inserted Succfully</div>';
                                } else {
                                    $success = '<div class="alert alert-danger">Service Type NOt Inserted Succfully</div>';
                                }
                            }
                        }
                        ?>
                        ...
                        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <button type="submit" class="btn btn-info" name="submit">Create Service Type</button>
                                    </div>
                                </div>
                            </div>
                        </form>
