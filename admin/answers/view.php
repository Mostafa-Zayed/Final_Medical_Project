...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h4><a href="<?=ADMIN_URL?>index.php">Dashboard<a> / <a href="<?=ADMIN_URL.'answers/view.php'?>"> Answers </a><a href="<?=ADMIN_URL.'answers/add.php';?>" class="btn btn-primary pull-right">ADD ANSWER</a></h4>
            <br>
            <div class="col-lg-12">
                <div style="display:none" id="message"></div>
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Answers</h3>
                    </div>
