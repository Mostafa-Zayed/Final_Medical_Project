...
<ul class="nav navbar-nav side-nav">
    ...
    <li><a href="<?=ADMIN_URL.'service_types/view.php';?>"><i class="fa fa-globe"></i> Servie Types</a></li>
    <li><a href="<?=ADMIN_URL.'departments/view.php'?>"><i class="fa fa-list-ol"></i> Departments</a></li>
    <li><a href="<?=ADMIN_URL.'admins/view.php';?>"><i class="fa fa-globe"></i> Admins</a></li>
    <li><a href="<?=ADMIN_URL.'brands/view.php';?>"><i class="fa fa-globe"></i> Brands</a></li>
    <li><a href="<?=ADMIN_URL.'services/view.php';?>"><i class="fa fa-globe"></i> Services</a></li>
    <li><a href="<?=ADMIN_URL.'appointments/view.php';?>"><i class="fa fa-globe"></i> Appointments</a></li>
    <li><a href="<?=ADMIN_URL.'sliders/view.php';?>"><i class="fa fa-globe"></i> Sliders</a></li>
    <li><a href="<?=ADMIN_URL.'pages/view.php';?>"><i class="fa fa-globe"></i> Pages</a></li>
    <li><a href="<?=ADMIN_URL.'doctors/view.php';?>"><i class="fa fa-globe"></i> Doctors</a></li>
